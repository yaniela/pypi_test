...
setup(
  name = 'ainwater_package_test',         # How you named your package folder (MyLib)
  packages = ['ainwater_package_test'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/yaniela/pypi_test/archive/refs/tags/v0.3.tar.gz',    # I explain this later on
